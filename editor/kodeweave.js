...
document.querySelector("[data-action=save-gist]").onclick = function() {
  ...
  $.ajax({
    ...
    document.querySelector("[data-output=projectURL]").value = "https://alegorico.github.io/forkKodeWeave/editor/#" + embedProject;
    ...
    $("[data-target=editorURL]").on("change", function() {
      ...
      previewWeave.src = "https://alegorico.github.io/forkKodeWeave/embed/#" + embedProject + "?" + showEditors;
      document.querySelector("[data-output=embedProject]").value = "<iframe width=\"100%\" height=\"300\" src=\"https://alegorico.github.io/kodeWeave/embed/#" + embedProject + "?" + showEditors + "\" allowfullscreen=\"allowfullscreen\" frameborder=\"0\"></iframe>";
    });
    ...
    $(".share-facebook").attr("href", "https://www.facebook.com/sharer/sharer.php?u=https%3A//alegorico.github.io/forkKodeWeave/editor/%23" + hash);
    $(".share-twitter").attr("href", "https://twitter.com/home?status=Checkout%20my%20"+ document.querySelector("[data-action=sitetitle]").value.split(" ").join("%20") +"%20%23weave%20on%20%23kodeWeave%20%23kodeWeaveShare%20-%20https%3A//alegorico.github.io/forkKodeWeave/e/%23" + hash);
    $(".share-gplus").attr("href", "https://plus.google.com/share?url=https%3A//alegorico.github.io/forkKodeWeave/editor/%23" + hash);
    $(".share-linkedin-square").attr("href", "https://www.linkedin.com/shareArticle?mini=true&url=https%3A//alegorico.github.io/forkKodeWeave/editor/%23"+ hash +"&title=Checkout%20my%20%23weave%20on%20%23forkKodeWeave%3A%20&summary=&source=");
