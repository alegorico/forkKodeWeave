...
document.querySelector("[data-action=save-gist]").onclick = function() {
  ...
  $.ajax({
    ...
    document.querySelector("[data-output=projectURL]").value = "https://alegorico.github.io/kodeWeave/editor/#" + embedProject;
    ...
    $("[data-target=editorURL]").on("change", function() {
      ...
      previewWeave.src = "https://alegorico.github.io/kodeWeave/embed/#" + embedProject + "?" + showEditors;
